...
public class GlobalExceptionalHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> stockIdNotFoundException(StockIdNotFoundException exception, WebRequest request) {
	...
	public ResponseEntity<?> invalidQuantityException(InvalidQuantityException exception, WebRequest request) {
